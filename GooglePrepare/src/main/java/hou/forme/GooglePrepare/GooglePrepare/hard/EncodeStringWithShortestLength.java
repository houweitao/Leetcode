...
/**
 * @author houweitao
 * @date 2016年12月18日下午9:30:09
 * @url https://discuss.leetcode.com/topic/71963/accepted-solution-in-java
 * 
	...
	public String encode(String s) {
		...
		for (int l = 0; l < s.length(); l++) {
			for (int i = 0; i < s.length() - l; i++) {
				...
				// Checking if string length < 5. In that case, we know that
				...
				if (j - i < 4) {
					...
					// the strings into 2 and combine the results of 2
					// substrings
					for (int k = i; k < j; k++) {
